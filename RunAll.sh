...
do
   ...
   ./Execute --Input /data/submit/mitay/photons/regulate_aa_qcd_weighted_${PTHatMin}_F.root --Fraction $Fraction \
		--Output Output/regulate_aa_qcd_weighted_${PTHatMin}_F_0.root \
		--PTHatMin $PTHatMin --PTHatMax $PTHatMax \
      --PVz 0.032223,0.433841,4.954461,0.032147,0.909282,4.964185
done
...
./ExecuteCombine --Input Output/regulate_aa_qcd_weighted_15_F_0.root,Output/regulate_aa_qcd_weighted_30_F_0.root,Output/regulate_aa_qcd_extra_old_weighted_50_F_0.root,Output/regulate_aa_qcd_extra_old_weighted_80_F_0.root,Output/regulate_aa_qcd_extra_old_weighted_120_F_0.root,Output/regulate_aa_qcd_extra_old_weighted_170_F_0.root \
		--Output regulate_aa_qcd.root
...
./ExecuteShow --Input regulate_aa_qcd_extra.root,regulate_aa_qcd_aod.root,regulate_aa_qcd_extra_old.root,regulate_aa_qcd.root\
	...
	--Output PlotComparison_nocent_20230304.pdf \
